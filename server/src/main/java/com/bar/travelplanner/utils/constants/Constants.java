package com.bar.travelplanner.utils.constants;

public class Constants {
    public static final String CHAT_COMPLETION = "gpt-3.5-turbo";
    ...
    public static final String SUCCESSFULLY_REGISTERED_MESSAGE = "User Registered Successfully!";
}
